...
bool BitcoinGUI::event(QEvent * e) // overloading event(QEvent*) method of QMainWindow
{
    switch(e->type())
    {
    ...
    nWeight(0)
{
    ...
    //set paddings
    overviewPage->setContentsMargins(20,20,20,20);
    transactionsPage->setContentsMargins(50,50,50,50);
    addressBookPage->setContentsMargins(50,50,50,50);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbarShadow->setColor(QColor(128, 128, 128, 128));
    toolbarShadow->setOffset(3.0);
