    ...
    tab(tab)
{
    ...
    inputShadow->setBlurRadius(10.0);
    inputShadow->setColor(QColor(128, 128, 128, 128));
    inputShadow->setOffset(2.0);
    ui->tableView->horizontalHeader()->setGraphicsEffect(inputShadow);
