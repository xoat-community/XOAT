    ...
    model(0)
{
    ...
    ui->frameCoinControl->setGraphicsEffect(shadow);
    ...
    formShadow->setBlurRadius(25.0);
    formShadow->setColor(QColor(80, 80, 80, 128));
    formShadow->setOffset(3.0);
    setGraphicsEffect(formShadow);
